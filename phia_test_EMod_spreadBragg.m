...
for pp = 1:length(phioffsets)
    ...
    fieldpathname = '""';
    GPTpathname = 'C:\bin\'; 
    masterfilename = sprintf('EnergyMod_phi%.2f.in', phioffsetE);
    ...
    dgamma0 = (energy0*.0003+938.27)/938.27-1; % .03% energy spread
    ...
    Qtot0 = 4.2e-15; % assumes 6 uA pulsed average current
    zposE0 = zlen0/1.8; %.03;
    sc = 0;
    tdiff = .001/beta0/c;
